...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String websiteLogo = "/admin/dist/img/diandi.png";
    public static final String websiteIcon = "/admin/dist/img/favicon.png";

    public static final String yourAvatar = "/admin/dist/img/yy.png";
    public static final String yourEmail = "853323110@qq.com";
    public static final String yourName = "yy";

    public static final String footerAbout = "your personal blog. have fun.";
    public static final String footerICP = "ICP备 NO ICP";
    public static final String footerCopyRight = "@2019 yy";
    public static final String footerPoweredBy = "点滴 blog";
